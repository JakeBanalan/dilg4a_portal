                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <multiselect v-model="selectedObligation"
                                                            :options="selectObligation" :searchable="false"
                                                            :multiple="false" label="name" track-by="id">
                                                        </multiselect>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <multiselect v-model="selectedSupplier"
                                                            :options="selectSupplier" :multiple="false"
                                                            :close-on-select="true" placeholder="Select supplier"
                                                            label="supplier_title" track-by="id" />
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label>Address:</label>
...
export default {
    ...
    computed: {
        selectedSupplier: {
            get() {
                return this.selectSupplier.find(
                    supplier => supplier.supplier_title === this.ObligationData.supplier_title
                ) || null;
            },
            set(selected) {
                if (selected) {
                    this.ObligationData.supplier_title = selected.supplier_title;
                    this.ObligationData.address = selected.supplier_address || ''; // auto-set address
                } else {
                    this.ObligationData.supplier_title = '';
        ...
        selectedObligation: {
            get() {
                return this.selectObligation.find(
                    type => type.id === this.ObligationData.type
                ) || null;
            }
        },
    },
    methods: {
        ...
        fetchObligationData() {
            ...
            axios.get(`/api/fetchObligationData/${id}`)
                .then(response => {
                    this.ObligationData = response.data[0];
