        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form class="formQObjectives" @submit.prevent="postUpdateQualityObjectives">
                                    ...
                                    <div class="row">
                                        <div class="col-md-7">
                                            ...
                                            <textarea rows="3" col="100" style="height:135px !important;"
                                                v-model="form.objective" id="objective" class="form-control"></textarea>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="col-md-12">
                                                <label>Target (%)</label>
                                                <input type="text" class="form-control" id="target_percentage" v-model="form.target_percentage"/>
                                            </div>
                                            <br>
                                            <div class="col-md-12">
                                                <label>Formula</label>
                                                <!-- <input type="text" class="form-control" id="formula" v-model="form.formula"/> -->
...
export default {
    ...
    created() {
        this.fetchQualityObjectives()
    },
    methods: {
        fetchQualityObjectives(){
            let qoeID = this.$route.params.id;
            let id = this.$route.params.qoe_id;
            axios.get(`/api/UpdateQualityObjectives/${id}/${qoeID}`)
                .then(response => {
        ...
        postUpdateQualityObjectives(){
            ...
            const data = {
                id:id,
                   ...
                   target_percentage:this.form.target_percentage,
            ...
            console.log(data)
            axios.post('/api/postUpdateQualityObjectives',
                {
                   id:id,
                   qop_id:qoeID,
                   objective:this.form.objective,
                ...
                .then(response => {
                    toast.success('Quality Objective Successfully Added!!', {
                        autoClose: 1000
                    });
